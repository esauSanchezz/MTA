        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalSalesCash = table.Column<decimal>(type: "numeric", nullable: false),
                    TotalSalesCard = table.Column<decimal>(type: "numeric", nullable: false),
                    TotalSalesTransfer = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashRegisterCuts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CashRegisterCuts_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleTasks_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduleTasks_Sales_SaleId",
                        column: x => x.SaleId,
                        principalTable: "Sales",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ScheduleTasks_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ScheduleTasks_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashRegisterCuts_TenantId",
                table: "CashRegisterCuts",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleTasks_EmployeeId",
                table: "ScheduleTasks",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleTasks_SaleId",
                table: "ScheduleTasks",
                column: "SaleId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleTasks_ServiceId",
                table: "ScheduleTasks",
                column: "ServiceId");
